...
//             <Image src="/images/ratsms.png" alt="ratsms-logo" className="w-40" />
//           </Link> */}
//           <Link href="https://ratsms.com" passHref>
//   {/* <Image
//     // src="/images/ratsms.png"
//     alt="ratsms-logo"
//     width={160} // Replace 160 with your image's actual width
//     height={80} // Replace 80 with your image's actual height
//     className="w-40"
//   /> */}
// </Link>
...
//         {/* Navbar Links */}
//         <nav className="hidden md:flex  pl-[40rem] space-x-12 ">
...
//     >
//       <span className="text-base font-roboto text-center text-white p-12 group-hover:text-black transition-all duration-300 ease-in-out">
//         Over View
//       </span>
//       <span
...
//   </button>
//   {isPopupVisible && (
//   <div className="fixed top-24 right-0 flex justify-end z-50 w-auto  mr-16 rounded-none ">
//     <div className="bg-white p-6 max-w-md w-full shadow-lg relative rounded-xl">
...
//         <FontAwesomeIcon icon={faPhone} /> <strong>9655735150</strong>
//       </p>
...
//     <li>
//       <Link href="/bulk-sms" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         Bulk SMS 
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
...
//     </li>
//     <li>
//       <Link href="/bulk-sms-gateway-aggregator" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
...
//     </li>
//     <li>
//       <Link href="/developer-api" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         Developer API
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
...
//     </li>
//     <li>
//       <Link href="/about-us" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         About Us
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
...
//     </li>
//     <li>
//       <Link href="/blog" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         Blogs
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
...
//     </li>
//     <li>
//       <Link href="/terms-and-conditions" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
...
//     </li>
//     <li>
//       <Link href="/refund-policy" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         Refund Policies
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
...
//     </li>
//     <li>
//       <Link href="/privacy-policy" className="flex items-centerjustify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         Privacy Policy
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
...
//     </li>
//     <li>
//       <Link href="/careers" className="flex items-center justify-start text-2xl font-medium text-white hover:text-[#003bff] transition-all duration-300 group">
//         Careers
//         <span
//         className="text-black font-bold text-2xl transition-transform 
//                    duration-300 ease-in-out  group-hover:translate-x-2 text-transparent transform scale-0 group-hover:text-[#003bff] group-hover:scale-100 "
