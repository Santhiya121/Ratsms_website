    ...
    return (
        <footer className="bg-black text-white py-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 md:px-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-center lg:text-left">
                        <li><a href="/company" className="text-white">Company</a></li>
                        <li><a href="/about" className="text-white">About</a></li>
                        <li><a href="/services" className="text-white">Services</a></li>
                        <li><a href="/industries" className="text-white">Industries</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-center lg:text-left">
                        <li><a href="/services/google-verified-sms" className="hover:text-blue-400">Google Verified SMS</a></li>
                        <li><a href="/services/rcs-business-messaging" className="hover:text-blue-400">RCS Business Messaging</a></li>
                        <li><a href="/services/whatsapp-business-api" className="hover:text-blue-400">WhatsApp Business API</a></li>
                        <li><a href="/services/transactional-sms" className="hover:text-blue-400">Transactional SMS</a></li>
                        <li><a href="/services/promotional-sms" className="hover:text-blue-400">Promotional SMS</a></li>
                        <li><a href="/services/otp-sms" className="hover:text-blue-400">OTP SMS</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-center lg:text-left">
                        ...
                        <li><a href="/white-label-reseller-program" className="hover:text-blue-400">White Label Reseller Program</a></li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10 border-t border-gray-700 pt-6 px-4 md:px-8">
                ...
                <div className="text-center">
                    <p>
                        <Link href="/privacy-policy" className="hover:text-blue-400">Privacy Policy</Link> | <a href="/terms-conditions" className="hover:text-blue-400">Terms & Conditions</a>
                    </p>
                </div>
                <div className="flex justify-center md:justify-end space-x-6">
                    <a href="#" className="text-2xl hover:text-blue-500"><i className="fab fa-linkedin"></i></a>
                    <a href="#" className="text-2xl hover:text-red-900"><i className="fab fa-youtube"></i></a>
