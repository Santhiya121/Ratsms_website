export default function PlaceContent({ city }) {
    return (
      <div className="min-h-screen +bg-black py-12 px-8">
        {/* Heading */}
        <h1 className="text-4xl font-light text-white mb-8 text-center drop-shadow-lg">
        ...
        <div className="bg-white p-8  max-w-5xl w-full mb-10 mx-auto">
          <h2 className="text-3xl font-semibold text-black mb-6 text-center">Why Bulk SMS?</h2>
        ...
        <div className="bg-white p-8  max-w-5xl w-full mb-10 mx-auto">
          <h2 className="text-3xl font-semibold text-black mb-6 text-center">Bulk SMS Best Practices</h2>
          <ul className="list-disc pl-8 text-lg text-gray-700 space-y-4">
        ...
        <div className="bg-white p-8  max-w-5xl w-full mb-10 mx-auto">
          <h2 className="text-3xl font-semibold text-black mb-6 text-center">Why Choose Us?</h2>
