...
export default function Indust() {
  return (
    <>
      ...
      {/* Content Section */}
      <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-7xl mt-12 ">
        {/* Left Side: Text and Button */}
        <div className="max-w-xl text-left md:text-left sm:text-center sm:pl-20">
          <p className="text-black sm:text-lg text:base md:text-xl font-roboto tracking-widest ">
            Empowering industries with innovation and expertise.
            Creating lasting impact across diverse sectors.
          </p>
          <Link href = "/contact">
          <div className="mt-6">
            <Button />
      ...
      <p className="text-lg  text-center max-w-6xl mx-auto text-gray-700">
        ...
        scalable bulk SMS solutions. Whether you are in finance, healthcare, retail, 
        education, logistics, or e-commerce, our platform ensures fast, secure, and 
      ...
      {/* CTA Section */}
      <p className="text-lg text-gray-950 text-center max-w-3xl mx-auto mt-10">
        No matter your industry, RAT SMS ensures fast, secure, and reliable messaging 
        to connect with your audience effortlessly. Start today and boost your 
