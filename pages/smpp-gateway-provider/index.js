...
export default function Smpp() {
  return (
    <>
     <LocalBusinessSchema
      name = "RAT SMS"
      description="Responsible for managing and optimizing SMPP connections, troubleshooting SMS delivery issues, and ensuring seamless bulk messaging operations."
