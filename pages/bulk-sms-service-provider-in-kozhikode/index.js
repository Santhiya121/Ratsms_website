...
export default function BulkSmsServiceProvider() {
  return (
    ...
    <LocalBusinessSchema  
      name = "RAT SMS"
      description="Reliable bulk SMS service provider in Kozhikode offering promotional, transactional, and OTP messaging solutions for businesses."
      url="https://ratsms.com/bulk-sms-service-provider-in-kozhikode"
      city="kozhikode"
      address="Cyberpark, KINFRA Park"
      latitude="11.182460443483084"
      longitude="75.85538369676155"
      pincode="673016"
      />
      {/* Meta Tags */}
      <Head>
