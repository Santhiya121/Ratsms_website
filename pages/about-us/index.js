...
//   <meta
//     name="description"
//     content="Discover Rat SMS, India's leading bulk SMS service provider. Experience seamless communication, reliable message delivery, and innovative solutions tailored to your business needs. Trusted by 37,350+ global clients."
//   />
...
const AboutUsPage = ({ metaDescription }) => {
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
...
export async function getServerSideProps() {
  // Fetch dynamic description from an API or data source
  const metaDescription = "Discover Rat SMS, India's leading bulk SMS service provider. Experience seamless communication, reliable message delivery, and innovative solutions tailored to your business needs.";
